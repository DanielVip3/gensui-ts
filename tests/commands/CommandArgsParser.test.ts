...
describe("Command's CommandArgsParser usage", function() {
    ...
    describe("Types", function() {
        ...
        it("parser accepts inline function types", async function() {
            const parser: CommandArgsParser = new CommandArgsParser({
                id: "arg1",
                type: () => null,
            }, {
            ...
            expect(response).to.have.property("arg1", null);
        });
    ...
    describe("Default values", function() {
        ...
        it("default values are used if argument gets casted to null by the type casting when using multiple (array) types", async function() {
            const parser: CommandArgsParser = new CommandArgsParser({
                id: "arg1",
                type: ["whole", "boolean"], // it casts to null because it's not a whole number neither boolean
                default: "defaultValue"
            }, {
                id: "arg2",
                type: "string",
